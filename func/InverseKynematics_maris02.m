function [zita_d, sigma_tilde_a, sigma_tilde_b, sigma_tilde_c] = InverseKynematics_maris02(eta_ee1_d,...
    eta_ee_quat_d, eta, q, DH, PARAM)
%
% Computes the inverse kynematics for MARIS: algorithm 02
%
% function [zita_d, sigma_tilde_a, sigma_tilde_b, sigma_tilde_c] = InverseKynematics_maris02(eta_ee1_d,...
%    eta_ee_quat_d, eta, q, DH, PARAM)
%
