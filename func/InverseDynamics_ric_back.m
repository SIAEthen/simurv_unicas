...
R_0_B = T_0_B(1:3,1:3);
[sigma_f, sigma_m] = FrameTransfForce(R_0_B, temp_sigma_f, temp_sigma_m, r_B0_B);

% force/moment acting on the vehicle
if strcmp(PARAM.type,'Romeo')
    tau(1:6) = InverseDynamics_Romeo(Rpy2Quat(eta2), nu, dnu, rho, g0) + [sigma_f; sigma_m];
else
