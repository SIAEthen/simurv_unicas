...
r_B0_B = [0 0 .5]';	% vector position from origin of frame B to the
...
a2 = 1.2*r_B0_B(3);		% vehicle-fixed y
a3 = 1*r_B0_B(3);		% vehicle-fixed z
...
r_l = [.15 .10 .1];  % link radius [m]
L_l = [1  .5 .5];   %link length [m]
